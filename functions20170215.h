...
// void func_B (GtkWidget *name, gpointer user_data) { return;}
// void func_C (GtkWidget *name, gpointer user_data) { return;}
// void func_D (GtkWidget *name, gpointer user_data) { return;}
// 
