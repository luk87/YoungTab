...
#include <limits.h>
#include "typedef.h"
#include "functions20170429b.h"




// tabside defines the dimension of the drawing area
int tabside=20;
...
//we compute the center of the cell of the tableaux, size is the dimension of the single cell  
...
//control sequence for the tableaux
...
//call for the functions computing the dimensions of the tableaux  
...
//connection of the signal with callback functions
